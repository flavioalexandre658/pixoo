...
import { Navbar } from "../(lp)/_components/navbar";
import Footer from "../(lp)/_components/footer";
import Hero from "../(lp)/_components/hero";
import Features from "../(lp)/_components/features";
import FAQ from "../(lp)/_components/faq";
import CTABanner from "../(lp)/_components/cta-banner";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
    ...
    const pageUrl = `${baseUrl}/${locale}/gerador-imagens-ia`;
...
export default async function AiImageGeneratorPage({ params }: Props) {
    ...
    // Redirect non-Portuguese locales to their respective routes
    if (locale !== 'pt') {
        notFound();
    }
