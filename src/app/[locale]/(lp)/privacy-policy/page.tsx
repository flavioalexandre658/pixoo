        ...
        <PageContainer>
            <div className="mx-auto max-w-4xl space-y-8 py-12 lg:py-24">
                ...
                <div className="prose prose-lg mx-auto max-w-full text-grafite-600 dark:prose-invert dark:text-grafite-400">
                    ...
                    <p>
                        Welcome to {process.env.NEXT_PUBLIC_APP_NAME}. We are committed to protecting your privacy.
                    ...
                    <ul>
                        <li>
                            ...
                            to us when you register with the Application or when you choose
                            to participate in various activities related to the Application.
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            about our services from the Application.
                        </li>
                    </ul>
