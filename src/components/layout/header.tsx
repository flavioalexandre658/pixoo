...
export function Header({ className }: HeaderProps) {
  ...
  return (
    <>
      <header
        className={cn(
          "relative top-0 z-40 w-full border-b border-pixoo-purple/20 bg-background/95 backdrop-blur-sm supports-[backdrop-filter]:bg-background/60 overflow-hidden",
          ...
          <div className="flex items-center gap-2">
            ...
            {session?.user && (
              <Button
                ...
                className="flex items-center gap-2 h-8 px-3 bg-gradient-to-r from-pixoo-purple/10 to-pixoo-magenta/10 hover:from-pixoo-purple/20 hover:to-pixoo-magenta/20 border-pixoo-purple/20 transition-all duration-300"
              >
                <Coins className="h-4 w-4 text-pixoo-purple" />
